...
def main():
    st.set_page_config(
        page_title="Dengue Virus 2 Africa Dashboard",
        layout="wide",
    ...
    main_title("DENGUE VIRUS 2 - AFRICA DASHBOARD" , display_countries)
    ...
    if map_option == 'Total number of genomes':
        ...
        colorpath_africa_map(df_count_map, column=c1, color_pallet=dengue_two_color.get(voc_selected))
