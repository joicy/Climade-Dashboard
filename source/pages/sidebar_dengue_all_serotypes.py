...
def new_build_variant_percentage(df_count):
    ...
    # now we create a sort_key dictionary
    # first we sum all the cols in the df
    # then we only choose the percentage ones by passing percentage_variant to it
    # now we need to convert our sort_key list to a dictionary using dict() function
